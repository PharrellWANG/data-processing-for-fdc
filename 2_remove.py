...
list_of_input_files = [
    homedir + '/data/pure_eval/step1_output/size_04_files.csv',
    homedir + '/data/pure_eval/step1_output/size_08_files.csv',
    homedir + '/data/pure_eval/step1_output/size_16_files.csv',
    homedir + '/data/pure_eval/step1_output/size_32_files.csv',
    homedir + '/data/pure_eval/step1_output/size_64_files.csv',
]
