...
input_files = [
    ...
    '/Users/Pharrell_WANG/data/two_classes/separate_classes/train_32x32.csv',
    '/Users/Pharrell_WANG/data/two_classes/separate_classes/test_32x32.csv',
    '/Users/Pharrell_WANG/data/two_classes/separate_classes/validation_32x32.csv'
]


output_files = [
    homedir + '/data/two_classes/train_32x32_homo_and_edge.csv',
    homedir + '/data/two_classes/test_32x32_homo_and_edge.csv',
    homedir + '/data/two_classes/validation_32x32_homo_and_edge.csv'
]
