...
list_of_input = [
    ...
    # homedir + '/data/pure_eval/step5_output/eval_16x16.csv',
    homedir + '/data/pure_eval/step5_output/eval_32x32.csv',
    # homedir + '/data/pure_eval/step5_output/eval_64x64.csv',
]
list_of_output = [
    # homedir + '/data/pure_eval/step6_output/eval_08x08.csv',
    # homedir + '/data/pure_eval/step6_output/eval_16x16.csv',
    homedir + '/data/pure_eval/step6_output/eval_32x32.csv',
